...
async def generate_3d_model(
    ...
    shape_creators = {
        ...
        "cone": lambda: create_pyramid(base_radius=pattern_scale, height=pattern_scale * 2, sides=32),
        "cube": lambda: create_cube(size=pattern_scale * 2),
        "cuboid": lambda: create_cube(size=pattern_scale * 2),
        "hexagonal_prism": lambda: create_hexagonal_prism(radius=pattern_scale, height=pattern_scale * 2),
        "pyramid": lambda: create_pyramid(base_radius=pattern_scale, height=pattern_scale * 2, sides=4),
        ...
        "wireframe_surface": lambda: create_sphere(radius=pattern_scale, subdivisions=subdivision_level),
    }
